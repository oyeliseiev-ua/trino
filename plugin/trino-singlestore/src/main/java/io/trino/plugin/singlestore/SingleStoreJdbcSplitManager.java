...
public class SingleStoreJdbcSplitManager extends JdbcSplitManager
{
    private final JdbcClient jdbcClient;

    @Inject
    public SingleStoreJdbcSplitManager(JdbcClient jdbcClient)
    {
        super(jdbcClient);
            ...
            Constraint constraint)
    {
        ...
        if (dynamicFilteringEnabled(session)) {
            return new SingleStoreDynamicFilteringJdbcSplitSource(jdbcSplitSource, dynamicFilter, tableHandle);
        }
